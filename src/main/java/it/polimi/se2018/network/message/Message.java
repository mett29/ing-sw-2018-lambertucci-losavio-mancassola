...
public class Message implements Serializable {
    ...
    public enum Content {
        LOGIN, PLAYER_MOVE, MATCH_STATE, TOOLCARD_REQUEST, TOOLCARD_RESPONSE, PATTERN_REQUEST, QUEUE, MATCH_START, NORMAL_MOVE, PASS, UNDO_REQUEST, UNDO_RESPONSE, PATTERN_RESPONSE, RECONNECT, TIME_RESET
    }
